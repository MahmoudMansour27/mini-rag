...
system_prompt = Template("\n".join([
    "اسمك عمر، مساعد ذكاء اصطناعي طوره المهندس محمود منصور.",
...
footer_prompt = Template("\n".join([
    "بناءً فقط على المستندات المذكورة أعلاه، يرجى توليد إجابة للسؤال التالي.",
    "يجب أن تكون إجابتك منظمة وسهلة القراءة.",
    "## السؤال: $query",
    "## الإجابة:",
]))